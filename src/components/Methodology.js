  ...
  const cards = steps.map((s, i) => `
    <div class="reveal" style="transition-delay:${i * 150}ms;position:relative;z-index:2;">
        <div style="background:#fff;border-radius:16px;padding:32px;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
            <!-- Number circle -->
            <div style="width:48px;height:48px;border:2px solid #E8900A;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                <span style="font-size:20px;font-weight:700;color:#E8900A;">${s.num}</span>
            </div>
            <!-- Title -->
            ...
            <!-- Deliverable -->
            <div style="background:rgba(232,144,10,0.08);padding:12px;border-radius:8px;">
    ...
    <section id="metodologia" class="section-padding" style="background:#F2EDE5;">
        <div class="container-nevss" style="text-align:center;">
            ...
            <div class="reveal" style="margin-bottom:48px;">
                <p style="font-size:11px;font-weight:700;color:#E8900A;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:12px;">Como Trabalhamos</p>
                <h2 class="resp-h2" style="font-size:48px;font-weight:700;color:#1A1A1A;line-height:1.1;margin:0;">
                    Nosso Método de <span style="font-family:'Playfair Display',serif;color:#E8900A;font-style:italic;">ESCALA</span>
                </h2>
            </div>
            ...
            <div style="position:relative;">
                ...
                <div class="hidden lg:block" style="position:absolute;top:56px;left:15%;right:15%;height:2px;background:#E8900A;z-index:1;"></div>
