                ...
                <div>
                    ...
                    <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:16px;">
                        ...
                        <li style="display:flex;align-items:flex-start;gap:10px;">
                            ...
                            <a href="https://wa.me/557591989954" target="_blank" rel="noopener noreferrer" style="font-size:14px;color:#e8d5f5;text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='#D4A017'" onmouseout="this.style.color='#e8d5f5'">+55 75 9198-9954</a>
                        </li>
                        <li style="display:flex;align-items:flex-start;gap:10px;">
