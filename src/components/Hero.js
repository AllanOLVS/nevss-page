...
export function Hero() {
    ...
    <section id="hero" class="section-padding bg-white" style="padding-top:160px;min-height:100vh;display:flex;align-items:center;">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <div class="reveal" style="margin-bottom:24px;">
                        <span style="display:inline-block;padding:6px 16px;background:rgba(232,144,10,0.12);color:#C47A08;font-size:13px;font-weight:600;border-radius:20px;">
                    ...
                    <h1 class="reveal resp-h1" style="font-family:'Inter',sans-serif;font-size:56px;font-weight:700;line-height:1.08;color:#1A1A1A;margin:0 0 24px;text-transform:uppercase;">
                        ...
                        FEITA SOB MEDIDA:<br>
                        <span style="font-family:'Playfair Display',serif;color:#E8900A;font-style:italic;text-transform:none;font-weight:700;">
                    ...
                    <div class="reveal" style="display:flex;gap:32px;align-items:center;flex-wrap:wrap;">
                        <div>
                            <p style="font-size:24px;font-weight:700;color:#E8900A;margin:0;">+20</p>
                        ...
                        <div>
                            <p style="font-size:24px;font-weight:700;color:#E8900A;margin:0;">+5</p>
                            <p style="font-size:13px;color:#777;font-weight:400;margin:0;">Anos de resultados</p>
                        </div>
                        <div style="width:1px;height:40px;background:#E5E0D8;"></div>
                        <div>
                            <p style="font-size:24px;font-weight:700;color:#E8900A;margin:0;">100%</p>
                    ...
                    <div style="position:relative;min-height:420px;">
                        ...
                        <div style="background:#fff;border-radius:16px;border:0.5px solid #E5E0D8;padding:20px;box-shadow:0 8px 40px rgba(0,0,0,0.08);position:relative;z-index:2;margin-top:180px;">
                            ...
                            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:16px;">
                                <div style="background:linear-gradient(135deg,#E8900A,#F5B041);border-radius:8px;aspect-ratio:1;display:flex;align-items:center;justify-content:center;">
                                ...
                                <div style="background:#F2EDE5;border-radius:8px;aspect-ratio:1;"></div>
                                ...
                                <div style="background:#F2EDE5;border-radius:8px;aspect-ratio:1;"></div>
                                <div style="background:linear-gradient(135deg,#E8900A,#D07E08);border-radius:8px;aspect-ratio:1;display:flex;align-items:center;justify-content:center;color:white;font-size:19px;font-weight:800;">N</div>
                                <div style="background:#F2EDE5;border-radius:8px;aspect-ratio:1;"></div>
                            </div>
                            <!-- Mock metrics bar -->
                            <div style="display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:#FAF8F4;border-radius:10px;">
                                <div style="display:flex;align-items:center;gap:8px;">
                                    <div style="width:32px;height:32px;border-radius:50%;background:#E8900A;display:flex;align-items:center;justify-content:center;">
                                ...
                                <span style="font-size:15px;font-weight:700;color:#E8900A;">+240%</span>
                            </div>
                        </div>

                        <!-- Card flutuante topo-esquerda: Clientes -->
                        <div class="animate-float" style="position:absolute;top:-12px;left:-12px;z-index:3;background:#fff;border-radius:14px;padding:12px 16px;box-shadow:0 4px 20px rgba(0,0,0,0.1);display:flex;align-items:center;gap:10px;">
                            <div style="display:flex;">
                                ...
                                <div style="width:28px;height:28px;border-radius:50%;background:rgba(232,144,10,0.2);border:2px solid #fff;margin-left:-8px;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;color:#E8900A;">R</div>
                        ...
                        <div class="animate-float" style="position:absolute;bottom:20px;left:-20px;z-index:3;background:#1A1A1A;border-radius:14px;padding:14px 18px;box-shadow:0 4px 20px rgba(0,0,0,0.15);animation-delay:1.5s;">
                            <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="#E8900A"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
